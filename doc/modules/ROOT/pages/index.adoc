...
This guide uses Striim evaluation version hosted at https://hub.docker.com/r/striim/evalversion/[Striim DockerHub].
...
If you experience an expired license key issue:
